...
const OwnersHeader = () => {
    return (
        <div className="flex justify-between text-center w-full items-center bg-blue-100 py-4 sm:text-sm text-[12px] font-semibold text-slate-500 shadow-sm border-b-[1px] border-slate-300">
