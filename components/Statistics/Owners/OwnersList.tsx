...
const OwnersList = ({ owners }: {owners: Array<IOwner>}) => {
    const renderedOwners = owners.map(owner => (
        <div key={owner._id} className="flex justify-between text-center w-full items-center  bg-blue-50 py-4 text-sm text-slate-500 shadow-sm border-b-[1px] border-slate-300">
